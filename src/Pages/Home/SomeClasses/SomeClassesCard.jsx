    ...
    return (
        ...
        <div className='card w-96 h-[500px]  bg-base-100 shadow-xl text-white'>
          ...
          <div className='card-body items-center text-center'>
            ...
            <p className='text-lg text-pink-600'><span className="font-bold">Price:</span>  ${price}</p>
            <p className='text-sm text-gray-500 font-semibold'>{short_description}</p>
            <p className="text-pink-600"><span className="font-bold ">Enrolled:</span>{total_enrollment}</p>
